...
<section class="mission-sec">
            <div class="container">
                ...
                <div class="btn-div text-center">
                    <button class="btn btn-custom green-bg round-look color-white">Donate</button>
                    <button class="btn btn-custom green-bg round-look color-white">Volunteer</button>
                    <button class="btn btn-custom green-bg round-look color-white">Sponsor</button>
                    <button class="btn btn-custom green-bg round-look color-white">Pledge</button>
                </div>
            </div>
        </section>
                        ...
                        <div class="tab-pane fade" id="trees-benefits">
                            ...
                            <div class="box-wrap">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="tab-img-right">
                                            <img src="img/value-of-tree.png" class="img-responsive" alt="walnut-creek" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="tab-img-left">
